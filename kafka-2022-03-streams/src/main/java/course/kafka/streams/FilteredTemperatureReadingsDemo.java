...
public class FilteredTemperatureReadingsDemo {
    ...
    public static void main(String[] args) {
        ...
        KStream<String, TimestampedTemperatureReading> internalTemperature = builder.stream(INTERNAL_TEMP_TOPIC);
        KStream<String, TimestampedTemperatureReading> externalTemperature = builder.stream(EXTERNAL_TEMP_TOPIC);

        internalTemperature.to(OUTPUT_TOPIC);
        externalTemperature.to(OUTPUT_TOPIC);
